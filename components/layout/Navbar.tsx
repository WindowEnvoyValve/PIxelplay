...
const NAV_ITEMS = [
  ...
  { href: "/letsplay", label: "LETS PLAY", special: true },
            ...
            if (item.special) {
              return (
                <Link
                  key={item.href}
                  href={item.href}
                  className="group relative flex items-center justify-center overflow-visible px-4 py-2.5"
                >
                  <span className="relative z-10 inline-block whitespace-nowrap font-display text-base font-black uppercase tracking-[0.2em] text-white transition-all duration-300 group-hover:text-white group-hover:animate-pulse" style={{ textShadow: '0 1px 0 #cc5500, 0 2px 0 #cc5500, 0 3px 0 #cc5500, 0 4px 0 #993d00, 0 5px 0 #993d00, 0 6px 8px rgba(0,0,0,0.5)', animation: 'float-3d 4s ease-in-out infinite' }}>
                    {item.label}
                  </span>
                </Link>
              );
          ...
          >
            ...
            if (item.special) {
              return (
                ...
                >
                  <Link
                    ...
                    className="group relative block whitespace-nowrap px-3 py-4 text-center"
                  >
                    <span className="relative z-10 inline-block font-display text-lg font-black uppercase tracking-[0.2em] text-white transition-all duration-300 group-hover:text-white group-hover:animate-pulse" style={{ textShadow: '0 1px 0 #cc5500, 0 2px 0 #cc5500, 0 3px 0 #cc5500, 0 4px 0 #993d00, 0 5px 0 #993d00, 0 6px 8px rgba(0,0,0,0.5)', animation: 'float-3d 4s ease-in-out infinite' }}>
                      {item.label}
                    </span>
                  </Link>
                </motion.div>
              ...
              <div className="mt-3 flex items-center justify-between gap-3">
                ...
                <Link href="/login" onClick={closeMobileMenu} className="cyber-button !px-5 !py-2.5">
                  Войти
                </Link>
              </div>
            </div>
