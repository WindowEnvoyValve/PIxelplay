...
- **P3: 3**
  - На главной рекламный текст заявляет мониторы до 540 Hz, а текущие структурированные данные содержат максимум 360 Hz.
...
- Проверить маркетинговое утверждение «мониторы до 540Hz»: оно расходится с текущими данными клубов (максимум 360Hz).
